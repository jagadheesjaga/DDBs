...
public class Despatchlogin extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.despatchlogin);
                ...
                if (isOnline()) {
                    ...
                    if (textString != null && textString.trim().length() == 0) {
                        ...
                        if(textString.equals(A)){
                            ...
                            Intent myIntent = new Intent(context, Despatch.class);
