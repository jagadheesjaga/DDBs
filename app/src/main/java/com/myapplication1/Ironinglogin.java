...
public class Ironinglogin extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    private static final int TIME_INTERVAL = 3000; // # milliseconds, desired time passed between two back presses.
    private final String SOAP_ACTION_password = "http://tempuri.org/*****";
    private final String METHOD_NAME_password = "******";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ironinglogin);
                ...
                if (isOnline()) {
                    ...
                    if (textString != null && textString.trim().length() == 0) {
                        ...
                        if(textString.equals(A)){
                            ...
                            Intent myIntent = new Intent(context, Ironing.class);
